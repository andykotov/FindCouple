...
struct CardBehavior {
    ...
    var closeAllCardsDelay: Double = 2.0
    var countCardRow: Int = 4
    var cardArray = ["banana", "banana2", "fruit", "fruit2", "fruit3", "harvest", "juice", "leaf", "milk", "shake", "split", "split2", "split3", "split4", "split5", "split6"]
